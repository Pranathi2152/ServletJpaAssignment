...
public class AddBook extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String publisher=request.getParameter("publ");
		
		String bookId2=request.getParameter("bkid2");
		String bookName2=request.getParameter("bkname2");
		String author2=request.getParameter("author2");
		String publisher2=request.getParameter("publ2");
